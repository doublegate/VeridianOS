...
7. **Phase 5.5** (Bridge): Infrastructure for Phase 6 - **~58% actual** (Waves 1-3 complete; DMA/IOMMU, shared mem, Unix sockets, lock-free paths; 5/12 sprints remaining)
...
| **Latest Release** | v0.5.11 (February 27, 2026) - Phase 5.5 Wave 3: DMA/IOMMU foundation, POSIX shared memory, Unix domain sockets, lock-free RCU/hazard pointers/MPSC queue |
...
**Previous Releases**: v0.5.10, v0.5.9, v0.5.8, v0.5.7, v0.5.6, v0.5.5, v0.5.4, v0.5.3, v0.5.2, v0.5.1, v0.5.0, v0.4.9, v0.4.6, v0.4.5, v0.4.4, v0.4.3, v0.4.2, v0.4.1, v0.4.0, v0.3.9, v0.3.8, v0.3.7, v0.3.6, v0.3.5, v0.3.4, v0.3.3, v0.3.2, v0.3.1, v0.3.0, v0.2.5, v0.2.1, v0.2.0, v0.1.0
