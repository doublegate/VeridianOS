...
use veridian_kernel::{
    ipc::{shared_memory::Permission, IpcCapability, IpcPermissions, Message, SmallMessage},
...
fn test_message_size_limits() {
    use veridian_kernel::ipc::message::{DATA_REGISTERS, SMALL_MESSAGE_MAX_SIZE};
...
fn test_zero_copy_flags() {
    use veridian_kernel::ipc::zero_copy::{CachePolicy, TransferFlags, TransferType};
