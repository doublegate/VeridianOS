...
#
# Usage:
#   cmake -DCMAKE_TOOLCHAIN_FILE=path/to/veridian-x86_64.cmake ..
#
# Prerequisites:
#   - x86_64-veridian cross-compiler toolchain installed
#   - VeridianOS sysroot populated at ${VERIDIAN_SYSROOT}
#
# Environment variables:
#   VERIDIAN_SYSROOT  - Path to the VeridianOS sysroot (default: /opt/veridian/sysroot/x86_64)
...
set(CROSS_COMPILE "x86_64-veridian-")
...
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -march=x86-64 -mtune=generic")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} -march=x86-64 -mtune=generic")
