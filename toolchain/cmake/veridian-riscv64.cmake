# CMake toolchain file for cross-compiling to VeridianOS (RISC-V 64)
#
# Usage:
#   cmake -DCMAKE_TOOLCHAIN_FILE=path/to/veridian-riscv64.cmake ..
#
# Prerequisites:
#   - riscv64-veridian cross-compiler toolchain installed
#   - VeridianOS sysroot populated at ${VERIDIAN_SYSROOT}
#
# Environment variables:
#   VERIDIAN_SYSROOT  - Path to the VeridianOS sysroot (default: /opt/veridian/sysroot/riscv64)
...
if(DEFINED ENV{VERIDIAN_SYSROOT})
    ...
    set(VERIDIAN_SYSROOT "/opt/veridian/sysroot/riscv64")
endif()

# Cross-compiler configuration
set(CROSS_COMPILE "riscv64-veridian-")
...
# Architecture-specific flags for RISC-V 64
# RV64GC: General-purpose (I+M+A+F+D+C extensions)
# -mabi=lp64d: LP64 with hardware double-precision float ABI
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -march=rv64gc -mabi=lp64d -mtune=generic")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} -march=rv64gc -mabi=lp64d -mtune=generic")
