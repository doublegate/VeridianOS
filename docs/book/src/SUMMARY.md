...
- [Building VeridianOS](./getting-started/building.md)
- [Running in QEMU](./getting-started/running.md)
- [Development Setup](./getting-started/dev-setup.md)

# Architecture

- [Overview](./architecture/overview.md)
- [Microkernel Design](./architecture/microkernel.md)
...
- [x86_64](./platforms/x86_64.md)
- [AArch64](./platforms/aarch64.md)
- [RISC-V](./platforms/riscv.md)

# Kernel Subsystems

- [Boot Process](./kernel/boot.md)
- [Memory Allocator](./kernel/allocator.md)
...
- [System Call API](./api/syscalls.md)
